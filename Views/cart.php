...
require_once("../controllers/CartDecorator.php");

$cartController = new cartController($conn);
$cartDecorator = new CartDecorator($cartController);

// Handle removing items from the cart
if (isset($_GET['remove'])) {
    $cartDecorator->removeCartItem($_GET['remove']);
}

// Handle clearing the entire cart
if (isset($_GET['clear'])) {
    $cartDecorator->clearCart();
}

// Get cart items
$cartItems = $cartDecorator->getCartItems();
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <?php if (isset($_SESSION['showAlert'])) : ?>
                    <div style="display: <?= $_SESSION['showAlert'] ?>;" class="alert alert-success alert-dismissible mt-3">
                        ...
                        <tbody>
                            ...
                            foreach ($cartItems as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="cart.php?remove=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');">
                            ...
                            <tr>
                                <td colspan="3">
                                    <a href="shopp.php" class="btn btn-success">
